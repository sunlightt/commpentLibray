        ...
        subtasks: [
            {
                ...
                subtasks: [
                    ...
                    { taskID: 4, taskName: "Plan budget", startDate: new Date( "02/03/2014"), endDate: new Date( "02/07/2014"), duration: 5, progress: "100", resourceId: [1] },
                    { taskID: 5, taskName: "Allocate resources", startDate: new Date( "02/03/2014"), endDate: new Date( "02/07/2014"), duration: 5, progress: "100", resourceId: [1] },
                    { taskID: 6, taskName: "Planning complete", startDate: new Date( "02/07/2014"), endDate: new Date( "02/07/2014"), duration: 0, predecessor: "3FS,4FS,5FS" }
                ]
            },            
            {
                taskID: 7,
