...
var textWrapData = [
     {
         ...
         approved: false,
         subtasks: [
             { taskID: 2, taskName: "Software Specification", startDate: new Date("02/10/2014"), endDate: new Date("02/12/2014"), duration: 3, progress: 60, priority: "Normal", approved: false },
             { taskID: 3, taskName: "Develop prototype", startDate: new Date("02/10/2014"), endDate: new Date("02/12/2014"), duration: 3, progress: 100, priority: "Critical", approved: false },
             { taskID: 4, taskName: "Get approval from customer", startDate: new Date("02/13/2014"), endDate: new Date("02/14/2014"), duration: 2, progress: 100, approved: true },
             { taskID: 5, taskName: "Design Documentation", startDate: new Date("02/13/2014"), endDate: new Date("02/14/2014"), duration: 2, progress: 100, approved: true },
             { taskID: 6, taskName: "Design complete", startDate: new Date("02/14/2014"), endDate: new Date("02/14/2014"), duration: 0, progress: 0, priority: "Normal", approved: true }
         ]
     },
	 {
	     taskID: 7,
	     ...
	     subtasks: [
             {
                 ...
                 subtasks: [{
                     ...
                     approved: false,
                     subtasks: [
                         { taskID: 10, taskName: "Development Task 1", startDate: new Date("02/17/2014"), endDate: new Date("02/19/2014"), duration: 3, progress: "50", priority: "High", approved: false },
                         { taskID: 11, taskName: "Development Task 2", startDate: new Date("02/17/2014"), endDate: new Date("02/19/2014"), duration: 3, progress: "50", priority: "Low", approved: true },
                         { taskID: 12, taskName: "Testing", startDate: new Date("02/20/2014"), endDate: new Date("02/21/2014"), duration: 2, progress: "0", priority: "Normal", approved: true },
                         { taskID: 13, taskName: "Bug fix", startDate: new Date("02/24/2014"), endDate: new Date("02/25/2014"), duration: 2, progress: "0", priority: "Critical", approved: false },
                         { taskID: 14, taskName: "Customer review meeting", startDate: new Date("02/26/2014"), endDate: new Date("02/27/2014"), duration: 2, progress: "0", priority: "High", approved: false },
                         { taskID: 15, taskName: "Phase 1 complete", startDate: new Date("02/27/2014"), endDate: new Date("02/27/2014"), duration: 0, priority: "Low", approved: true }
...

             {
                 ...
                 subtasks: [{
                     ...
                     duration: 12,
                     subtasks: [
                         { taskID: 18, taskName: "Development Task 1", startDate: new Date("02/17/2014"), endDate: new Date("02/20/2014"), duration: 4, progress: "50", priority: "Normal", approved: true },
                         { taskID: 19, taskName: "Development Task 2", startDate: new Date("02/17/2014"), endDate: new Date("02/20/2014"), duration: 4, progress: "50", priority: "Critical", approved: true },
                         { taskID: 20, taskName: "Testing", startDate: new Date("02/21/2014"), endDate: new Date("02/24/2014"), duration: 2, progress: "0", priority: "High", approved: false },
                         { taskID: 21, taskName: "Bug fix", startDate: new Date("02/25/2014"), endDate: new Date("02/26/2014"), duration: 2, progress: "0", priority: "Low", approved: false },
                         { taskID: 22, taskName: "Customer review meeting", startDate: new Date("02/27/2014"), endDate: new Date("02/28/2014"), duration: 2, progress: "0", priority: "Critical", approved: true },
                         { taskID: 23, taskName: "Phase 2 complete", startDate: new Date("02/28/2014"), endDate: new Date("02/28/2014"), duration: 0, priority: "Normal", approved: false }
...

             {
                 ...
                 subtasks: [{
                     ...
                     duration: 11,
                     subtasks: [
                         { taskID: 26, taskName: "Development Task 1", startDate: new Date("02/17/2014"), endDate: new Date("02/19/2014"), duration: 3, progress: "50", priority: "Low", approved: true },
                         { taskID: 27, taskName: "Development Task 2", startDate: new Date("02/17/2014"), endDate: new Date("02/19/2014"), duration: 3, progress: "50", priority: "Normal", approved: false },
                         { taskID: 28, taskName: "Testing", startDate: new Date("02/20/2014"), endDate: new Date("02/21/2014"), duration: 2, progress: "0", priority: "Critical", approved: true },
                         { taskID: 29, taskName: "Bug fix", startDate: new Date("02/24/2014"), endDate: new Date("02/25/2014"), duration: 2, progress: "0", priority: "High", approved: false },
                         { taskID: 30, taskName: "Customer review meeting", startDate: new Date("02/26/2014"), endDate: new Date("02/27/2014"), duration: 2, progress: "0", priority: "Normal", approved: true },
                         { taskID: 31, taskName: "Phase 3 complete", startDate: new Date("02/27/2014"), endDate: new Date("02/27/2014"), duration: 0, priority: "Critical", approved: false },
